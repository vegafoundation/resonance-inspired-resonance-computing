...
\title{Inspired Resonance Computing: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Inspired Resonance Computing'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
